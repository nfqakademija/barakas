...
class PromoteUserCommand extends Command
{
     ...
     */
    public function __construct(EntityManagerInterface $entityManager, $adminRole = 'ROLE_SUPER')
    {
    ...
    {
        $this
            ->setDescription('Make user super admin')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (in_array($this->adminRole, $user->getRoles())) {
            ...
            $io->success('Super Admin role already exists');
            return;
        }
        ...
        $io->success('Super Admin role successfully added');
    }
